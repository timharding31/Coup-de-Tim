...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"assets/365573eabb127bb1d9944a7612e6fafe.png\");\n\n//# sourceURL=webpack:///./src/images/coin.png?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Gameplay; });\n/* harmony import */ var _game_game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../game/game */ \"./src/game/game.js\");\n/* harmony import */ var _util_create_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/create_element */ \"./src/util/create_element.js\");\n/* harmony import */ var _util_coin_array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/coin_array */ \"./src/util/coin_array.js\");\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\n\nvar Gameplay = /*#__PURE__*/function () {\n  function Gameplay(rootEl) {\n    _classCallCheck(this, Gameplay);\n\n    this.rootEl = rootEl;\n    this.game = new _game_game__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n    this.game.startGame();\n    this.render();\n  }\n\n  _createClass(Gameplay, [{\n    key: \"renderCourt\",\n    value: function renderCourt() {\n      return Object(_util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', {\n        \"class\": 'court'\n      }, this.game.courtDeck.render(), this.game.treasury.render());\n    }\n  }, {\n    key: \"renderCurrentPlayer\",\n    value: function renderCurrentPlayer() {\n      var currentPlayerHand = _util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"].apply(void 0, ['div', {\n        \"class\": 'current-player-hand'\n      }].concat(_toConsumableArray(this.game.currentPlayer.cards.map(function (card) {\n        return card.render();\n      }))));\n      var currentPlayerCoins = _util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"].apply(void 0, ['div', {\n        \"class\": 'current-player-coins'\n      }].concat(_toConsumableArray(_util_coin_array__WEBPACK_IMPORTED_MODULE_2__[\"default\"].slice(0, this.game.currentPlayer.coins))));\n      return Object(_util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', {\n        \"class\": 'current-player-station'\n      }, currentPlayerHand, currentPlayerCoins);\n    }\n  }, {\n    key: \"renderCurrentTarget\",\n    value: function renderCurrentTarget() {\n      var currentTargetHand = _util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"].apply(void 0, ['div', {\n        \"class\": 'current-target-hand'\n      }].concat(_toConsumableArray(this.game.currentTarget.cards.map(function (card) {\n        return card.render();\n      }))));\n      var currentTargetCoins = _util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"].apply(void 0, ['div', {\n        \"class\": 'current-target-coins'\n      }].concat(_toConsumableArray(_util_coin_array__WEBPACK_IMPORTED_MODULE_2__[\"default\"].slice(0, this.game.currentTarget.coins))));\n      return Object(_util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', {\n        \"class\": 'current-target-station'\n      }, currentTargetHand, currentTargetCoins);\n    }\n  }, {\n    key: \"render\",\n    value: function render() {\n      this.rootEl.innerHTML = '';\n      this.rootEl.appendChild(Object(_util_create_element__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', {\n        id: 'game'\n      }, this.renderCurrentTarget(), this.renderCourt(), this.renderCurrentPlayer()));\n    }\n  }]);\n\n  return Gameplay;\n}();\n\n\n\n//# sourceURL=webpack:///./src/render/gameplay.js?");

/***/ }),

/***/ "./src/util/coin_array.js":
/*!********************************!*\
  !*** ./src/util/coin_array.js ***!
  \********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _create_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create_element */ \"./src/util/create_element.js\");\n\n\nvar coin = __webpack_require__(/*! ../images/coin.png */ \"./src/images/coin.png\");\n\nvar createCoin = function createCoin() {\n  return Object(_create_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('div', {\n    id: 'coin',\n    style: \"background-image: url(\\\"\".concat(coin[\"default\"], \"\\\");\")\n  });\n};\n\nvar coinArray = [];\n\nwhile (coinArray.length < 50) {\n  coinArray.push(createCoin());\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (coinArray);\n\n//# sourceURL=webpack:///./src/util/coin_array.js?");
